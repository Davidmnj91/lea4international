...
type HostFamilyContactDetailsProps = {
  data: HostFamilyFormData;
  language: Language;
};
export const HostFamilyContactDetails = ({
  data,
  language,
}: HostFamilyContactDetailsProps) => {
  const t = emails[language].fields;
  return (
    <Column>
      <Text className='text-desktop-b-md text-europe'>
...
type InstitutionContactDetailsProps = {
...
export const InstitutionContactDetails = ({
  data,
  language,
}: InstitutionContactDetailsProps) => {
  const t = emails[language].fields;
  return (
    <Column>
      <Text className='text-desktop-b-md text-europe'>
      ...
      <Text className='text-desktop-b-md text-europe'>
        {t.culturalActivitiesIncluded}:{' '}
        <strong> {data.culturalActivitiesIncluded}</strong>
      </Text>
    </Column>
  );
};

type PartnerContactDetailsProps = {
  data: PartnerFormData;
  language: Language;
};
export const PartnerContactDetails = ({
  data,
  language,
}: PartnerContactDetailsProps) => {
  const t = emails[language].fields;
  return (
    <Column>
      <Text className='text-desktop-b-md text-europe'>
...
export const FormSummary = ({ language, contactData }: ContactEmailProps) => {
  switch (contactData.type) {
    ...
    case 'FAMILY':
      return (
        <HostFamilyContactDetails data={contactData.data} language={language} />
      );
    case 'INSTITUTION':
      return (
    ...
    case 'PARTNER':
      return (
        <PartnerContactDetails data={contactData.data} language={language} />
      );
  }
};
