...
export default function Page({ params: { locale } }: LanguagePageProps) {
  ...
  const t = useTranslations('destinations-page.destinations.dublin');

  const services = ['work-experience', 'job-shadowing', 'language-courses'];
  ...
  return (
    <div>
      <div
        ...
        style={{
          backgroundImage: `url(${dublin_bg.src}), linear-gradient(#0308227F,#0308227F)`,
