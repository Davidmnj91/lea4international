...
export const typographyClasses = cva('', {
  variants: {
    size: {
      ...
      'body-2xl': 'font-body text-b-2xl',
      'body-xl': 'font-body text-b-xl',
      'body-lg': 'font-body text-b-lg',
      'body-md': 'font-body text-b-md',
      'body-sm': 'font-body text-b-sm',
      'body-xs': 'font-body text-b-xs',
    },
    color: {
      europe: 'text-europe',
...
export const Typography = <Element extends ElementType = 'span'>({
  ...
  return (
    <Component
      className={cx(typographyClasses({ size, color, weight }), className)}
      {...rest}
    >
      {children}
    </Component>
