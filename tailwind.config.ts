  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'tablet-h-4xl': ['72px', '80px'],
        'tablet-h-3xl': ['54px', '62px'],
        'tablet-h-2xl': ['48px', '56px'],
        'tablet-h-xl': ['32px', '40px'],
        'tablet-h-lg': ['24px', '32px'],
        'tablet-h-md': ['18px', '26px'],
        'tablet-h-sm': ['16px', '16px'],
        // Body font sizes
        'b-xxl': ['34px', '42px'],
        'b-xl': ['24px', '32px'],
        'b-lg': ['20px', '28px'],
